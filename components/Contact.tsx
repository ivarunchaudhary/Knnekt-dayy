            ...
            <div className="text-dark rounded-xl bg-white p-4 sm:flex sm:justify-between md:p-2">
              ...
              <div className="mt-7 flex flex-col items-start justify-between sm:mt-0 sm:p-3">
                <p>
                  ...
                  <span className="text-dark-very-subtle -mt-0.5 block">Startup Operating Partner · Delhi NCR</span>
                </p>
                <p className="mt-6">
                  <a className="mono-text group flex items-center gap-5 rounded-full pr-4 font-mono outline-offset-2 outline-black" href="mailto:hello@knnekt.studio">
                    ...
                    <span className="text-dark/50 group-hover:text-dark group-focus-visible:text-dark transition-colors">hello@knnekt.studio</span>
                  </a>
                </p>
              </div>
            </div>
