      ...
      <div className="bg-panel relative isolate overflow-hidden rounded-xl">
        ...
        <div className="relative z-10 grid gap-x-1.5 gap-y-12 px-4 py-8 sm:p-8 lg:grid-cols-12 lg:gap-y-0 lg:p-12">
          <div className="flex flex-col justify-between lg:col-span-5 lg:pr-10">
            ...
            <div className="mt-12 rounded-xl bg-white p-4 sm:p-6 lg:mt-10">
              <p>
              ...
              <p className="mt-6">
                <a
                  className="mono-text group flex flex-wrap items-center gap-x-5 gap-y-2 rounded-full pr-4 font-mono outline-offset-2 outline-dark"
                  href={`mailto:${CONTACT_EMAIL}`}
                >
                  <span className="rounded-full bg-sky-deep px-7 py-3 text-white transition-colors group-hover:bg-dark group-focus-visible:bg-dark lg:px-5">
                    Or just email us
                  </span>
